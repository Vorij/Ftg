...
class AfkMod(loader.Module):
    """Предоставляет сообщение о том, что Вы не в сети. Перевёл на русский @Friendly_userbot - @ForceBrain"""
    strings = {"name": "Afk",
               "gone": "<b>[Afk] включен</b>",
               "back": "<b>[Afk] отключен</b>",
               "afk": "Я не в сети (уже <b>{}</b>)",
               "afk_reason": "Я не в сети (уже <b>{}</b>)\nПримечание: <i>{}</i>"}
    ...
    async def afkcmd(self, message):
        """.afk текст по желанию - Включает режим оффлайна"""
    ...
    async def unafkcmd(self, message):
        """.unafk - Отключает режим оффлайна"""
